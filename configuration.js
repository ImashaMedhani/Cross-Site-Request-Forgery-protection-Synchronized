...
//use this function to retrive the response values coming form server side
function loadDOC(method,url,htmlTag)
{
    var xhttp = new XMLHttpRequest(); //create variable for store HTTP requests
    xhttp.onreadystatechange = function() //excute when receive an answer from server side
    {
